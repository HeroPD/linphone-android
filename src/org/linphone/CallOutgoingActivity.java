		...
		mListener = new LinphoneCoreListenerBase(){
			...
			public void callState(LinphoneCore lc, LinphoneCall call, LinphoneCall.State state, String message) {
				if (call == mCall && State.Connected == state) {
					...
					} else if (message != null && call.getErrorInfo().getReason() == Reason.TemporarilyUnavailable) {
						displayCustomToast(getString(R.string.temporary_unavailable), Toast.LENGTH_SHORT);
					} else if (message != null && message.equalsIgnoreCase("Payment required")) {
						displayCustomToast(getString(R.string.payment_required), Toast.LENGTH_SHORT);
