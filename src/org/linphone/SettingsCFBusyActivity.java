 ...
 *
 */
public class SettingsCFBusyActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		title = getString(R.string.mnp_busy);
		setProgressView();
		
		OauthRequest request = new OauthRequest(
				UserControl.getCallForwardingBusy(), RequestType.GET);
				...
				try {
					...
					if (object.getInt("result") == 0) {
						...
						JSONObject active = data
								.getJSONObject("CallForwardingBusy");
	...
	private void setMainView(){
		...
		setContentView(R.layout.settings_cf_busy_activity);
	...
	private void save() {
		...
		String body = "{\"data\":\"{\\\"CallForwardingBusy\\\" : {\\\"@xmlns\\\" : \\\"http://schema.broadsoft.com/xsi\\\",\\\"active\\\" : "
				+ value
				+ ",\\\"forwardToPhoneNumber\\\" : \\\""
				+ forwardNumber.getText().toString() + "\\\"}}\"}";
		saveRequest(body, UserControl.getCallForwardingBusyPut(), RequestType.POST, "Busy answer");
